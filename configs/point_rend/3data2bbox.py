...
launcher = 'none'
load_from = 'Data2/Absolue3/Ours/best_coco_bbox_mAP_50_epoch_147.pth'
log_level = 'INFO'
...
model = dict(
    ...
    roi_head=dict(
        ...
        mask_roi_extractor=dict(
            ...
            out_channels=256,
            roi_layer=dict(output_size=14, type='SimpleRoIAlign'),
...
test_evaluator = dict(
    ann_file='data/coco1/annotations/instances_test2017.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric=[
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='data/coco1/annotations/instances_val2017.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric=[
