...
class PPAConvFCBBoxHead(BBoxHead):
...
@MODELS.register_module()
class PPAShared2FCBBoxHead(PPAConvFCBBoxHead):
...
@MODELS.register_module()
class PPAShared4Conv1FCBBoxHead(PPAConvFCBBoxHead):
