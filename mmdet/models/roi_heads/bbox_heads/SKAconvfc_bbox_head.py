...
class SKAConvFCBBoxHead(BBoxHead):
    ...
    def __init__(self,
        ...
        self.sknnet=SKAttention(channel=256)
         #########
...
@MODELS.register_module()
class SKAShared2FCBBoxHead(SKAConvFCBBoxHead):
...
@MODELS.register_module()
class SKAShared4Conv1FCBBoxHead(SKAConvFCBBoxHead):
